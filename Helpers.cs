...
public static class IconHelper
{
    ...
    private static readonly Dictionary<string, string> Paths = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["ruler"]       = """<path d="M21.3 8.7l-8.6 8.6c-1.1 1.1-2.9 1.1-4 0l-6-6c-1.1-1.1-1.1-2.9 0-4l8.6-8.6c1.1-1.1 2.9-1.1 4 0l6 6c1.1 1.1 1.1 2.9 0 4z"/><path d="M7.5 10.5l5-5"/><path d="M10.5 13.5l5-5"/><path d="M13.5 16.5l5-5"/>""",
        ...
        ["screwdriver"] = """<path d="M3 22l8.5-8.5"/><path d="M13.5 10.5l7-7-3-3-7 7 3 3z"/>""",
        ["weight"]      = """<circle cx="12" cy="15" r="6"/><path d="M9 9h6v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V9z"/><path d="M10 9V7h4v2"/>""",
        ...
        // Kategorisierung & UI
        ["tags"]          = """<path d="M9 5H2v7l6.29 6.29c.94.94 2.48.94 3.42 0l3.58-3.58c.94-.94.94-2.48 0-3.42L9 5z"/><circle cx="6" cy="9" r="1"/><path d="M14.5 4.5h-2l5.62 5.62a2 2 0 0 1 0 2.83l-4.95 4.95"/>""",
